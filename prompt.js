...
window.XUEXUE_CONFIG = {
  ...
  always: [
    ...
    "CONTEXT KIT RULE: After 3-4 exchanges where the student mentions a real-life situation (restaurant, travel, meeting, shopping, family dinner, date, work...), propose a contextual survival kit. Add [[CONTEXT_LESSON: topic]] at the END of your message. Only ONCE per session. Topic must be specific (not 'food' but 'commander au restaurant'). NEVER for: violence, drugs, sex, illegal activities.",
