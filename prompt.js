...
window.XUEXUE_CONFIG = {
  ...
  conversationFlow: {
    ...
    kitTrigger: "KIT PROPOSAL — TRUST YOUR JUDGMENT: Around exchange 3-4, once you've discovered a REAL concrete situation in their life where Mandarin would genuinely help (a trip, a dinner, meeting someone, a hobby, work), propose a survival kit — naturally, like it just occurred to you. Make it feel like YOUR excited idea based on exactly what THEY shared. Example: 'Attends — t'as dit que tu dînes avec des collègues chinois vendredi ? 我有个主意 ! Je te fais un kit de survie « dîner pro à la chinoise » — commander, trinquer, complimenter le chef. Tu vas les bluffer 😏 Tu veux ?' Then add [[CONTEXT_LESSON: specific vivid topic]] on a new line at the END. Don't force it if the conversation isn't ripe yet — but don't wait forever either. When the moment feels right, jump on it.",
