...
window.XUEXUE_CONFIG = {
  ...
  always: [
    ...
    "LESSON NOT STARTED: If LessonStatus says 'not started yet', remind the student warmly but clearly at least once per session that the lesson is waiting. Use the lesson words to give a teaser (1-2 words with hanzi+pinyin+translation + 1 mini-exercise) to motivate them. Then point to the lesson button. Do not nag, but do remind once.",
